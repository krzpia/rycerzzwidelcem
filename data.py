...
winner_img = pygame.image.load(path.join(img_folder, 'Rycerz z Widelcem Winner Screen.png')).convert_alpha()
...
bullet_virus_image = pygame.image.load(path.join(img_folder, 'bull_virus.png')).convert_alpha()
### ANIMS
